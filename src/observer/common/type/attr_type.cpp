...
const char *ATTR_TYPE_NAME[] = {"undefined", "chars", "texts", "ints", "bigints", "floats", "dates", "vectors", "booleans", "nulls"};
...
{
  return (type == AttrType::INTS || type == AttrType::BIGINTS || type == AttrType::FLOATS);
}
