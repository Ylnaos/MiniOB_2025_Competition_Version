...
public:
  ...
  virtual RC     create_index(Trx *trx, span<const FieldMeta> field_metas, const char *index_name, bool unique,
      bool vector_index, const string &distance_func, const string &index_type, int lists, int probes) = 0;
